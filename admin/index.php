...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:yellow">
		...
		<h2><Strong>Welcome Admin<strong></h2>
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
             ...
             <a href="index.php?page=manage_users"></span> Manage Users</a>
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <a href="index.php?page=update_password"></span> Update Password</a>
              
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" width="100" height="100" class="img-responsive" alt="Generic placeholder thumbnail">
              <a href="index.php?page=notification">Mange Notification</a>
